        ...
        function Servant(name, isPicture) {
            ...
            lib.skill._slEnterGame = {
                ...
                filter: function (event, player) {
                    return player == game.me && txhj && txhj.servant && txhj.servant.nickName;
                },
                content: function () {
                    if (servantData && servantData.skillDesc && lib.config.taixuhuanjing && lib.config.taixuhuanjing.servants) {
                        for (let i of lib.config.taixuhuanjing.servants) {
                            if (servantData.skillDesc[i]) {
                                var buffs = Object.keys(servantData.skillDesc[i]);
                                for (const buff of buffs) {
                                    if (player && typeof player.addSkill === 'function') {
        ...
        Servant.prototype.initSLEvent = function () {
            lib.skill._slDamage = {
                ...
                filter: function (event, player) {
                    ...
                    const serdata = servantData.action[actually];
            ...
            lib.skill._slUseCard = {
                ...
                filter: function (event, player) {
                    if (txhj && txhj.servant && txhj.servant.nowPlay) {
                        ...
                        var serdata = servantData.action[actually];
            ...
            lib.skill._slHurt = {
                ...
                forced: true,
                content: function () {
                    if (servantData.action[txhj.servant.nickName] && servantData.action[txhj.servant.nickName].shouji !== undefined) {
            ...
            for (let i of keys) {
                ...
                img.onclick = function (ev) {
                    ...
                    if (!mode) {
                        ...
                        lib.config.taixuhuanjing.servant.textName = txhj.servantData.servant[this.servantName].textName;
