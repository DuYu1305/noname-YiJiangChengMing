...
export let CONTENT = function (config, pack) {
    ...
    var qhly_DynamicPlayer = (function () {
      function DynamicPlayer(pathPrefix) {
        ...
        if (!offscreen) {
          ...
          // @ts-ignore
          decadeUI.bodySensor.addListener(newDuilib.throttle(function () {
        ...
        // @ts-ignore
          ...
          EpicFX.playDynamic = (player, character, character2, play, transform, cutdybg) => {
            ...
            if (player.dynamic && !play)
              player.stopDynamic();
            // @ts-ignore
            var duicfg = decadeUI.config || { dynamicSkin: true, showJieMark: true, dynamicSkinOutcrop: true };
            // @ts-ignore
            ...
            if (showDynamic && _status.mode != null) {
              ...
              for (var i = 0; i < avatars.length; i++) {
                ...
                if (lib.config['extension_千幻聆音_qhly_editDynamic'] && lib.qhly_skinEdit[game.qhly_getRealName(avatars[i])] && lib.qhly_skinEdit[game.qhly_getRealName(avatars[i])][editSkin] && lib.qhly_skinEdit[game.qhly_getRealName(avatars[i])][editSkin]['player'] && lib.qhly_skinEdit[game.qhly_getRealName(avatars[i])][editSkin]['player'][editArgument1] && lib.qhly_skinEdit[game.qhly_getRealName(avatars[i])][editSkin]['player'][editArgument1][theme]) {
                  ...
                  // @ts-ignore
                  // 判断editObject类型，与保存逻辑保持一致
                  var currentEditObject = editArgument1 === 'qianjing' ? 'qianjing' : (editArgument1 === 'beijing' || editArgument1 === 'beijing2') ? 'beijing' : 'dynamic';
                  // @ts-ignore
                  if (skinCopy.qianjing && lib.qhly_skinEdit[game.qhly_getRealName(avatars[i])][editSkin][editObject] && lib.qhly_skinEdit[game.qhly_getRealName(avatars[i])][editSkin][editObject]['qianjing'] && lib.qhly_skinEdit[game.qhly_getRealName(avatars[i])][editSkin][editObject]['qianjing'][theme]) {
                    // @ts-ignore
                    var resetQianjing = lib.qhly_skinEdit[game.qhly_getRealName(avatars[i])][editSkin][editObject]['qianjing'][theme];
                    skinCopy.qianjing.x = resetQianjing.x;
                    skinCopy.qianjing.y = resetQianjing.y;
                    skinCopy.qianjing.scale = resetQianjing.scale * (skinCopy ? skinCopy.qhly_resizeRatio : 1);
                    skinCopy.qianjing.angle = resetQianjing.angle;
                  }
          ...
          // @ts-ignore
          newDuilib.DynamicPlayer = qhly_DynamicPlayer;
        }
      }
      // @ts-ignore
    ...
    function qhly_init(character, character2, skill) {
        ...
        if (showDynamic && _status.mode != null) {
          ...
          for (var i = 0; i < avatars.length; i++) {
            ...
            if (lib.config['extension_千幻聆音_qhly_editDynamic'] && lib.qhly_skinEdit[realName] && lib.qhly_skinEdit[realName][skinName] && lib.qhly_skinEdit[realName][skinName].player && lib.qhly_skinEdit[realName][skinName].player.dynamic && lib.qhly_skinEdit[realName][skinName].player.dynamic[theme]) {
              ...
              // @ts-ignore
              // 根据上下文确定editObject类型，与保存逻辑保持一致
              var editObject = 'player';
              // @ts-ignore
              if (skinCopy.qianjing && lib.qhly_skinEdit[realName][skinName] && lib.qhly_skinEdit[realName][skinName][editObject] && lib.qhly_skinEdit[realName][skinName][editObject].qianjing && lib.qhly_skinEdit[realName][skinName][editObject].qianjing[theme]) {
                // @ts-ignore
                var resetQianjing = lib.qhly_skinEdit[realName][skinName][editObject].qianjing[theme];
                skinCopy.qianjing.x = resetQianjing.x;
                skinCopy.qianjing.y = resetQianjing.y;
                skinCopy.qianjing.scale = resetQianjing.scale * (skinCopy ? skinCopy.qhly_resizeRatio : 1);
                skinCopy.qianjing.angle = resetQianjing.angle;
      ...
      this.node.avatar.addEventListener(lib.config.touchscreen ? "touchstart" : "mousedown", function (e) {
        if (!lib.config['extension_千幻聆音_qhly_playerwindow']) return;
        e.preventDefault();
        ...
        if (jie != null) {
          ...
          if (jie == '界') {
            if (this.$jieMark == undefined)
              // @ts-ignore
              this.$jieMark = decadeUI.element.create('jie-mark', this);
            else
              // @ts-ignore
    ...
    function qhly_playdynamic(animation, deputy, cutdybg, ignoreClip) {
      ...
      if (!dynamic) {
        // @ts-ignore
        dynamic = new newDuilib.DynamicPlayer('assets/dynamic/');
        // @ts-ignore
      ...
      if (this.classList.contains('qh-isBigAvatar')) {
        dynamic.outcropMask = false;
        if (animation.player) {
          animation.player.outcropMask = false;
        }
        if (animation.dybg) {
          animation.dybg.outcropMask = false;
        }
      } else {
    ...
    lib.skill._qhlyPhaseSkinBegin = {
      ...
      content: function () {
        ...
        for (let i = 0; i < 2; i++) {
          ...
          // @ts-ignore
          let playerName = game.qhly_getRealName(player['name' + (i + 1)]);
          if (!playerName || !lib.qhly_skinChange[playerName]) continue;
          
          let targetSkin = null;
          for (let skinName in lib.qhly_skinChange[playerName]) {
            if (lib.qhly_skinChange[playerName][skinName].source == phaseType) {
              targetSkin = skinName;
              break;
            }
          }
    ...
    lib.skill._qhlyPhaseSkinEnd = {
      ...
      content: function () {
        ...
        for (let i = 0; i < 2; i++) {
          ...
          let skin = game.qhly_getSkin(playerName);
          // @ts-ignore
          let currentSkinName = game.qhly_earse_ext(skin);
          // @ts-ignore
          let currentStatus = game.qhly_getPlayerStatus(player, i == 1);
          ...
          for (let skinName in lib.qhly_skinChange[playerName]) {
            if (lib.qhly_skinChange[playerName][skinName].source == phaseType) {
              ...
              else if (currentStatus == 2 && player._qhly_skinChange && player._qhly_skinChange[i]) {
                let currentImagePath = player._qhly_skinChange[i].replace(/\\/g, '/');
                if (currentImagePath.indexOf(skinName) != -1) {
                  targetSkin = skinName;
                  break;
                }
              }
          ...
          if (targetSkin) {
            // @ts-ignore
            let oldStatus = game.qhly_getPlayerStatus(player, i == 1);
            // @ts-ignore
            game.qhly_setPlayerStatus(player, i == 1, 3 - oldStatus);
            // @ts-ignore
            game.qhly_checkPlayerImageAudio(playerName, skin, player, function () {
              if (!player._qhlyIsChanged) player._qhlyIsChanged = [0, 0];
              player._qhlyIsChanged[i] = 1 - player._qhlyIsChanged[i];
    ...
    // 检测造成伤害次数并且根据皮肤配置触发变身
    lib.skill._qhlyCheckDamageTimes = {
      trigger: {
        source: ['damage'],
      },
      filter: function (event, player) {
        function hasDamageTimesConfig(name) {
          if (!name) return false;
          // @ts-ignore
          let realName = game.qhly_getRealName(name);
          if (!realName || !lib.qhly_skinChange[realName]) return false;
          for (let skin in lib.qhly_skinChange[realName]) {
            let info = lib.qhly_skinChange[realName][skin];
            if (info && typeof info.source === 'string' && info.source.indexOf('damageTimes_') === 0) {
              return true;
            }
          }
          return false;
        }
        return hasDamageTimesConfig(player.name1) || hasDamageTimesConfig(player.name2);
      },
      direct: true,
      charlotte: true,
      forced: true,
      content: function () {
        // @ts-ignore
        if (!player._qhly_damageTimes) player._qhly_damageTimes = [0, 0];
        for (let i = 0; i < 2; i++) {
          // @ts-ignore
          if (!player['name' + (i + 1)]) continue;
          // @ts-ignore
          let realName = game.qhly_getRealName(player['name' + (i + 1)]);
          if (!realName || !lib.qhly_skinChange[realName]) continue;
          player._qhly_damageTimes[i] += 1;
          let targetKey = 'damageTimes_' + player._qhly_damageTimes[i];
          let matched = false;
          for (let skinName in lib.qhly_skinChange[realName]) {
            let info = lib.qhly_skinChange[realName][skinName];
            if (info && info.source === targetKey) {
              matched = true;
              break;
            }
          }
          if (!matched) continue;
          // @ts-ignore
          game.qhly_changeSkillSkin(player, targetKey);
        }
      }
    }
 ...
 //千幻势力变身自己加
  ...
  lib.skill._qhlyTransformGroup = {
    trigger: {
      player: 'useSkill'
    },
    filter: function (event, player) {
      if (event.skill != '_qhlyTransformGroup') return false;
      return lib.qhly_skinChange[game.qhly_getRealName(player.name1)] || lib.qhly_skinChange[game.qhly_getRealName(player.name2)];
    },
    direct: true,
    forced: true,
    ...
    content: function () {
      ...
      var currentPlayerGroupType = player.group;
      if (currentPlayerGroupType !== playerGroupType) {
        player.group = playerGroupType;
        if (player.node && player.node.name) {
          player.node.name.dataset.nature = get.groupnature(playerGroupType);
        }
        if (typeof game.qhly_changeSkillSkin === 'function') {
          game.qhly_changeSkillSkin(player, 'changeGroup');
        }
...
*/
    ...
    game.qhly_changeSkillSkin = function (player, skill) {
      ...
      // 处理回合内外变身
      if (skill == 'phaseBegin' || skill == 'phaseEnd') {
        for (let i = 0; i < 2; i++) {
          // @ts-ignore
          let playerName = game.qhly_getRealName(player['name' + (i + 1)]);
          if (!playerName || !lib.qhly_skinChange[playerName]) continue;
          ...
          // @ts-ignore
          let currentSkin = game.qhly_getSkin(player['name' + (i + 1)]);
          // @ts-ignore
          let currentSkinName = game.qhly_earse_ext(currentSkin);
          
          // 查找对应的变身皮肤
          let targetSkin = null;
          
          // 先检查新格式的配置
          if (lib.qhly_skinChange[playerName].condition && lib.qhly_skinChange[playerName].condition[skill]) {
            let transformName = lib.qhly_skinChange[playerName].condition[skill].transform;
            if (lib.qhly_skinChange[playerName].special && lib.qhly_skinChange[playerName].special[transformName]) {
              targetSkin = lib.qhly_skinChange[playerName].special[transformName].name;
            }
          }
          
          // 如果没有找到新格式的配置，检查旧格式
          // 先检查当前皮肤的配置
          if (!targetSkin && lib.qhly_skinChange[playerName][currentSkinName] && lib.qhly_skinChange[playerName][currentSkinName].source == skill) {
            targetSkin = currentSkinName;
          }
          
          // 如果当前皮肤没有匹配，再遍历所有配置查找
          if (!targetSkin) {
            for (let skinName in lib.qhly_skinChange[playerName]) {
              if (lib.qhly_skinChange[playerName][skinName].source == skill) {
                targetSkin = skinName;
                break;
              }
            }
          ...
          if (targetSkin) {
            ...
            let currentStatus = game.qhly_getPlayerStatus(player, i == 1);
            // @ts-ignore
            let skinConfig = lib.qhly_skinChange[playerName][targetSkin];
            // 对于phaseBegin和phaseEnd，如果当前皮肤就是targetSkin，说明是来回切换，应该允许
            // 对于其他情况，检查是否有return属性，如果没有return属性或return为false，则只在未变身时变身
            // @ts-ignore
            if (targetSkin != currentSkinName && !skinConfig.return && currentStatus == 2) {
              continue;
            }
            // @ts-ignore
            game.qhly_setPlayerStatus(player, i == 1, 3 - currentStatus);
            // @ts-ignore
            game.qhly_checkPlayerImageAudio(playerName, currentSkin, player, function () {
              if (!player._qhlyIsChanged) player._qhlyIsChanged = [0, 0];
              player._qhlyIsChanged[i] = 1 - player._qhlyIsChanged[i];
              player.node['avatar' + (i ? '2' : '')].qhly_origin_setBackgroundImage(player._qhly_skinChange[i]);
              // @ts-ignore
              ...
              if (!_status.qhly_replaceSkin[playerName]) _status.qhly_replaceSkin[playerName] = {};
              // @ts-ignore
              _status.qhly_replaceSkin[playerName][currentSkin] = player._qhly_skinChange[i];
              // @ts-ignore
              if (window.decadeUI && !game.qhly_hasExtension('皮肤切换') && !game.qhly_hasExtension('EpicFX')) game.qhly_changeDynamicSkin(player, undefined, undefined, i == 1);
            }, undefined);
          }
      ...
      for (let i = 0; i < 2; i++) {
        ...
        if (lib.qhly_skinChange[playerName] && lib.qhly_skinChange[playerName][game.qhly_earse_ext(skin)] && lib.qhly_skinChange[playerName][game.qhly_earse_ext(skin)].source && lib.qhly_skinChange[playerName][game.qhly_earse_ext(skin)].source == skill) {
          ...
          let currentStatus = game.qhly_getPlayerStatus(player, i == 1);
          // @ts-ignore
          let skinConfig = lib.qhly_skinChange[playerName][game.qhly_earse_ext(skin)];
          // 检查是否有return属性，如果没有return属性或return为false，则只在未变身时变身
          // @ts-ignore
          if (!skinConfig.return && currentStatus == 2) {
            continue;
          }
          // @ts-ignore
          game.qhly_setPlayerStatus(player, i == 1, 3 - currentStatus);
    ...
    game.qhly_getSkinLevel = function (name, skin, decade, dongtai) {
      ...
      if ((!lib.config.qhly_level || !lib.config.qhly_level[name + '_' + skin]) && !decade) return '默认';
      ...
      for (var dy = 0; dy < nodes.length; dy++) {
        ...
        if (_status.mode != null) {
          ...
          if (lib.config['extension_千幻聆音_qhly_editDynamic'] && lib.qhly_skinEdit[game.qhly_getRealName(character)] && lib.qhly_skinEdit[game.qhly_getRealName(character)][editSkin] && lib.qhly_skinEdit[game.qhly_getRealName(character)][editSkin][nodeType] && lib.qhly_skinEdit[game.qhly_getRealName(character)][editSkin][nodeType][editArgument1] && lib.qhly_skinEdit[game.qhly_getRealName(character)][editSkin][nodeType][editArgument1][theme]) {
            ...
            skinCopy.angle = resetDynamic.angle;
            // @ts-ignore
            if (skinCopy.qianjing && lib.qhly_skinEdit[game.qhly_getRealName(character)][editSkin][nodeType]['qianjing'] && lib.qhly_skinEdit[game.qhly_getRealName(character)][editSkin][nodeType]['qianjing'][theme]) {
              // @ts-ignore
              var resetQianjing = lib.qhly_skinEdit[game.qhly_getRealName(character)][editSkin][nodeType]['qianjing'][theme];
              skinCopy.qianjing.x = resetQianjing.x;
              skinCopy.qianjing.y = resetQianjing.y;
              skinCopy.qianjing.scale = resetQianjing.scale * skinCopy.qhly_resizeRatio;
              skinCopy.qianjing.angle = resetQianjing.angle;
            }
            // @ts-ignore
    ...
    game.qhly_checkPlayerImageAudio = function (name, skin, player, callbacka, callbackb, force) {
      ...
      if (lib.qhly_skinChange[name] && lib.qhly_skinChange[name][skinName] && lib.qhly_skinChange[name][skinName].source) {
        ...
        if (lib.qhly_skinChange[name][skinName].source.indexOf('hp_') == 0) {
          ...
          const skinChangeInfo = lib.qhly_skinChange[game.qhly_getRealName(name)][skinName];
          const changeIndex = avatar2 ? 1 : 0;
          if (player.hp <= hp) {
            // @ts-ignore
            if (game.qhly_getPlayerStatus(player, avatar2) != 2) {
              imageChanged = true;
              // @ts-ignore
              player._qhly_skinChange[changeIndex] = pkgPath + skinChangeInfo.image1;
            }
            // @ts-ignore
            ...
            if (player._qhly_gonnaChange && player._qhly_gonnaChange[changeIndex]) {
              // @ts-ignore
              const revertImage = skinChangeInfo.image2 || skinChangeInfo.image1;
              if (revertImage && game.qhly_getPlayerStatus(player, avatar2) != 1) {
                imageChanged = true;
                // @ts-ignore
                player._qhly_skinChange[changeIndex] = pkgPath + revertImage;
              }
              // @ts-ignore
              ...
              player._qhly_gonnaChange[changeIndex] = 0;
            } else {
              // @ts-ignore
              const revertImage = skinChangeInfo.image2 || skinChangeInfo.image1;
              if (revertImage && game.qhly_getPlayerStatus(player, avatar2) != 1) {
        ...
        } else if (lib.qhly_skinChange[name][skinName].source == 'phaseBegin' || lib.qhly_skinChange[name][skinName].source == 'phaseEnd') {
          // @ts-ignore
          let currentStatus = game.qhly_getPlayerStatus(player, avatar2);
          let correctSkinName = skinName;
          let correctSource = lib.qhly_skinChange[name][skinName].source;
          
          if (currentStatus == 2 && correctSource == 'phaseEnd') {
            for (let s in lib.qhly_skinChange[name]) {
              if (lib.qhly_skinChange[name][s].source == 'phaseBegin') {
                correctSkinName = s;
                correctSource = 'phaseBegin';
                break;
              }
            }
          } else if (currentStatus == 1 && correctSource == 'phaseBegin') {
            for (let s in lib.qhly_skinChange[name]) {
              if (lib.qhly_skinChange[name][s].source == 'phaseEnd') {
                correctSkinName = s;
                correctSource = 'phaseEnd';
                break;
              }
            }
          }
          
          let audioSkinName = null;
          if (currentStatus == 1) {
            for (let s in lib.qhly_skinChange[name]) {
              if (lib.qhly_skinChange[name][s].source == 'phaseEnd') {
                audioSkinName = s;
          ...
          if (currentStatus == 1) {
            // @ts-ignore
            let targetImage = pkgPath + lib.qhly_skinChange[game.qhly_getRealName(name)][correctSkinName].image;
            // @ts-ignore
            if (!player._qhly_skinChange[avatar2 ? 1 : 0] || player._qhly_skinChange[avatar2 ? 1 : 0] != targetImage) {
              imageChanged = true;
              // @ts-ignore
              player._qhly_skinChange[avatar2 ? 1 : 0] = targetImage;
            }
            for (let s in lib.qhly_skinChange[name]) {
              // @ts-ignore
              let oldAudioKey = name + '-' + s;
              if (window.qhly_audio_redirect[oldAudioKey]) {
                audioChanged = true;
                // @ts-ignore
                delete window.qhly_audio_redirect[oldAudioKey];
              }
            }
            // @ts-ignore
            let audioKey = name + '-' + skinName;
            let targetAudio = audioSkinName ? lib.qhly_skinChange[name][audioSkinName].audio : null;
            // @ts-ignore
            if (targetAudio && (!window.qhly_audio_redirect[audioKey] || window.qhly_audio_redirect[audioKey] != targetAudio)) {
              audioChanged = true;
              // @ts-ignore
              window.qhly_audio_redirect[audioKey] = targetAudio;
            }
          } else {
            // @ts-ignore
            let targetImage = pkgPath + lib.qhly_skinChange[game.qhly_getRealName(name)][correctSkinName].image;
      ...
      if (game.qhly_hasExtension('皮肤切换') && window.skinSwitch && lib.config[window.skinSwitch.configKey.useDynamic]) {
        ...
        if (window.qhly_newDynamicExt && lib.config['extension_EpicFX_skinEffects']) {
          ...
          if (res) {
            ...
            var tempX = node.dynamic.primary.x, chukuangX = tempX, qianjingX = tempX;
            var tempY = node.dynamic.primary.y, chukuangY = tempY, qianjingY = tempY;
            var tempA = node.dynamic.primary.angle || 0, chukuangA = tempA, qianjingA = tempA;
            var tempS = node.dynamic.primary.scale || 1, chukuangS = tempS, qianjingS = tempS;
            // @ts-ignore
            ...
            // 读取qianjing参数
            if (lib.qhly_skinEdit[realName] && lib.qhly_skinEdit[realName][skin] && lib.qhly_skinEdit[realName][skin].bigAvatar && lib.qhly_skinEdit[realName][skin].bigAvatar.qianjing && lib.qhly_skinEdit[realName][skin].bigAvatar.qianjing[theme]) {
              // @ts-ignore
              let res3 = lib.qhly_skinEdit[realName][skin].bigAvatar.qianjing[theme];
              if (res3.x != undefined) qianjingX = res3.x;
              if (res3.y != undefined) qianjingY = res3.y;
              if (res3.angle != undefined) qianjingA = res3.angle;
              if (res3.scale != undefined) qianjingS = res3.scale * (temp ? temp.qhly_resizeRatio : 1);
            }
    ...
    game.qhly_syncChangeSkinButton = function (name, skin, state) {
      ...
      if (lib.qhly_skinChange[name] && lib.qhly_skinChange[name][skinName]) {
        // 检查是否有回合内外变身
        let hasPhaseBegin = false;
        let hasPhaseEnd = false;
        
        // 检查新格式的配置
        if (lib.qhly_skinChange[name].condition) {
          if (lib.qhly_skinChange[name].condition.phaseBegin) hasPhaseBegin = true;
          if (lib.qhly_skinChange[name].condition.phaseEnd) hasPhaseEnd = true;
        }
        
        // 检查旧格式的配置
        if (!hasPhaseBegin && !hasPhaseEnd) {
          for (let skin in lib.qhly_skinChange[name]) {
            if (lib.qhly_skinChange[name][skin].source == 'phaseBegin') hasPhaseBegin = true;
            if (lib.qhly_skinChange[name][skin].source == 'phaseEnd') hasPhaseEnd = true;
          }
        }
            ...
            buttons[i].listen(function () {
              ...
              // @ts-ignore
                ...
                if (hasPhaseBegin || hasPhaseEnd) {
                  ...
                  if (this.id == 'qhlySkinChangebutton0' && hasPhaseBegin) {
                    targetSource = 'phaseBegin';
                    // 先检查新格式的配置
                    if (lib.qhly_skinChange[game.qhly_getRealName(name)].condition && lib.qhly_skinChange[game.qhly_getRealName(name)].condition.phaseBegin) {
                      let transformName = lib.qhly_skinChange[game.qhly_getRealName(name)].condition.phaseBegin.transform;
                      if (lib.qhly_skinChange[game.qhly_getRealName(name)].special && lib.qhly_skinChange[game.qhly_getRealName(name)].special[transformName]) {
                        targetSkin = lib.qhly_skinChange[game.qhly_getRealName(name)].special[transformName].name;
                      }
                    }
                    // 如果没有找到新格式的配置，检查旧格式
                    if (!targetSkin) {
                      for (let skin in lib.qhly_skinChange[game.qhly_getRealName(name)]) {
                        if (lib.qhly_skinChange[game.qhly_getRealName(name)][skin].source == 'phaseBegin') {
                          targetSkin = skin;
                          break;
                        }
                      }
                    }
                  } else if (this.id == 'qhlySkinChangebutton1' && hasPhaseEnd) {
                    targetSource = 'phaseEnd';
                    // 先检查新格式的配置
                    if (lib.qhly_skinChange[game.qhly_getRealName(name)].condition && lib.qhly_skinChange[game.qhly_getRealName(name)].condition.phaseEnd) {
                      let transformName = lib.qhly_skinChange[game.qhly_getRealName(name)].condition.phaseEnd.transform;
                      if (lib.qhly_skinChange[game.qhly_getRealName(name)].special && lib.qhly_skinChange[game.qhly_getRealName(name)].special[transformName]) {
                        targetSkin = lib.qhly_skinChange[game.qhly_getRealName(name)].special[transformName].name;
                      }
                    }
                    ...
                    if (!targetSkin) {
                      for (let skin in lib.qhly_skinChange[game.qhly_getRealName(name)]) {
                        if (lib.qhly_skinChange[game.qhly_getRealName(name)][skin].source == 'phaseEnd') {
                          targetSkin = skin;
                          break;
                        }
                      }
                  ...
                  if (targetSource && targetSkin) {
                    // 找到对应的玩家对象
                    let targetPlayer = null;
                    for (let p of game.players) {
                      if (p.name1 == name || p.name2 == name) {
                        targetPlayer = p;
                        break;
                      }
                    }
                    if (targetPlayer) {
                      // 直接设置变身皮肤路径
                      if (!targetPlayer._qhly_skinChange) targetPlayer._qhly_skinChange = ['', ''];
                      // @ts-ignore
                      var pkgPath = (targetPlayer.pkg && targetPlayer.pkg.isExt && game.qhly_getRealName(name) != name) ? DEFAULT_PACKAGE.skin.standard : (targetPlayer.pkg ? targetPlayer.pkg.skin.standard : 'sanguoskin/');
                      
                      // 根据配置格式设置皮肤路径
                      let skinPath = '';
                      if (lib.qhly_skinChange[game.qhly_getRealName(name)].special && lib.qhly_skinChange[game.qhly_getRealName(name)].special[targetSkin]) {
                        // 新格式：使用 special 中的配置
                        skinPath = pkgPath + targetSkin + '.jpg';
                      } else {
                        // 旧格式：使用 image 属性
                        skinPath = pkgPath + lib.qhly_skinChange[game.qhly_getRealName(name)][targetSkin].image;
                      }
                      
                      // 设置皮肤路径
                      targetPlayer._qhly_skinChange[this.id.slice(20) == '1' ? 1 : 0] = skinPath;
                      
                      // 切换状态
                      // @ts-ignore
                      game.qhly_setPlayerStatus(targetPlayer, this.id.slice(20) == '1', 3 - game.qhly_getPlayerStatus(targetPlayer, this.id.slice(20) == '1'));
                      
                      // 设置变身状态
                      if (!targetPlayer._qhlyIsChanged) targetPlayer._qhlyIsChanged = [0, 0];
                      targetPlayer._qhlyIsChanged[this.id.slice(20) == '1' ? 1 : 0] = 1 - targetPlayer._qhlyIsChanged[this.id.slice(20) == '1' ? 1 : 0];
                      
                      // 直接设置头像
                      targetPlayer.node['avatar' + (this.id.slice(20) == '1' ? '2' : '')].qhly_origin_setBackgroundImage(skinPath);
                      
                      // 记录皮肤替换
                      // @ts-ignore
                      if (!_status.qhly_replaceSkin) _status.qhly_replaceSkin = {};
                      // @ts-ignore
                      if (!_status.qhly_replaceSkin[game.qhly_getRealName(name)]) _status.qhly_replaceSkin[game.qhly_getRealName(name)] = {};
                      // @ts-ignore
                      _status.qhly_replaceSkin[game.qhly_getRealName(name)][game.qhly_getSkin(game.qhly_getRealName(name))] = skinPath;
                      
                      // 处理动态皮肤
                      // @ts-ignore
                      if (window.decadeUI && !game.qhly_hasExtension('皮肤切换') && !game.qhly_hasExtension('EpicFX')) game.qhly_changeDynamicSkin(targetPlayer, undefined, undefined, this.id.slice(20) == '1');
                    }
                  }
                } else {
                  // 对于其他类型的变身，使用原有的逻辑
    ...
    game.qhly_checkFileExist = function (path, callback) {
      ...
      } else if (typeof resolveLocalFileSystemURL !== 'undefined') {
        // @ts-ignore
        // @ts-ignore
        // @ts-ignore
    ...
    game.qhly_setOriginSkin = function (name, skin, node, state, skin2) {
      ...
      // @ts-ignore
      var originFrom1 = state.pkg.skin.origin;
      var originFrom2;
      var position = '50%';
      // @ts-ignore
    ...
    game.qhly_chooseDialog = function(title,detail,initValue,list,onok,onclose){
      ...
      var belowButton = "";
      // @ts-ignore
      belowButton += '<img src="' + lib.qhly_path + 'image/qhly_ok2.png" id="qhly_choose_okbutton' + id + '" style = "display:block; width:66px;height:20px;"/>&nbsp;&nbsp;&nbsp;&nbsp;';
      // @ts-ignore
      belowButton += '<img src="' + lib.qhly_path + 'image/qhly_cancel2.png" id="qhly_choose_cancelbutton' + id + '"style = "display:block; width:66px;height:20px;"/>';
    ...
    game.qhly_bigEdit = function (state, bg) {
      ...
      if (editDynamic) {
        ...
        if (focus.dynamic.primary.qianjing) {
          temp.qianjing.x = focus.dynamic.primary.qianjing.x || [0, 0.5];
          if (Array.isArray(temp.qianjing.x)) temp.qianjing.x[0] = 0;
          temp.qianjing.y = focus.dynamic.primary.qianjing.y || [0, 0.5];
          if (Array.isArray(temp.qianjing.y)) temp.qianjing.y[0] = 0;
          temp.qianjing.scale = focus.dynamic.primary.qianjing.scale || 1;
          temp.qianjing.angle = focus.dynamic.primary.qianjing.angle || 0;
          var qianjingX = [...temp.qianjing.x], qianjingY = [...temp.qianjing.y], qianjingS = temp.qianjing.scale, qianjingA = temp.qianjing.angle;
        }
      }
      ...
      function enlarge() {
        ...
        game.qhly_postMessage(focus, {
          ...
          player: pp,
          zhu: true,
          dybg: editMode == 'beijing' ? true : editMode == 'qianjing' ? 'qianjing' : undefined,
        }, editMode)
      }
      function shrink() {
        temp[editMode].scale -= 0.01;
        ...
        buttons[i].addEventListener(lib.config.touchscreen ? 'touchstart' : 'mousedown', function () {
          ...
          switch (this.id) {
            ...
            case 'qhly_bigedit5': {
              ...
              var btnQianjing = document.getElementById('qhly_bigedit8');
              if (this.classList.contains('sel')) {
                this.classList.remove('sel');
                if (btn) btn.classList.remove('forbid');
                if (btnQianjing) btnQianjing.classList.remove('forbid');
                // @ts-ignore
                ...
                if (btnQianjing) btnQianjing.classList.add('forbid');
                // @ts-ignore
                _status.qhly_editMode = editMode;
                editMode = "chukuang";
            ...
            case 'qhly_bigedit8': {
              ...
              var btn = document.getElementById('qhly_bigedit4');
              var btnChukuang = document.getElementById('qhly_bigedit5');
              if (this.classList.contains('sel')) {
                this.classList.remove('sel');
                if (btn) btn.classList.remove('forbid');
                if (btnChukuang) btnChukuang.classList.remove('forbid');
                // @ts-ignore
                editMode = _status.qhly_editMode;
                if (canvas) canvas.style.position = 'absolute';
              }
                ...
                this.classList.add('sel');
                if (btn) btn.classList.add('forbid');
                if (btnChukuang) btnChukuang.classList.add('forbid');
                // @ts-ignore
                _status.qhly_editMode = editMode;
                editMode = "qianjing";
                if (canvas) canvas.style.position = "fixed";
            ...
            case 'qhly_bigedit6': {
              if (editDynamic) {
                ...
                // 保存前景设置
                if (focus.dynamic.primary.qianjing && editObject != 'player') {
                  // @ts-ignore
                  var realName = game.qhly_getRealName(name);
                  // @ts-ignore
                  if (!lib.qhly_skinEdit[realName]) lib.qhly_skinEdit[realName] = {};
                  // @ts-ignore
                  if (!lib.qhly_skinEdit[realName][skin]) lib.qhly_skinEdit[realName][skin] = {};
                  // @ts-ignore
                  if (!lib.qhly_skinEdit[realName][skin].bigAvatar) lib.qhly_skinEdit[realName][skin].bigAvatar = {};
                  // @ts-ignore
                  if (!lib.qhly_skinEdit[realName][skin].bigAvatar.qianjing) lib.qhly_skinEdit[realName][skin].bigAvatar.qianjing = {};
                  // @ts-ignore
                  if (!lib.qhly_skinEdit[realName][skin].bigAvatar.qianjing[theme]) lib.qhly_skinEdit[realName][skin].bigAvatar.qianjing[theme] = {};
                  // @ts-ignore
                  lib.qhly_skinEdit[realName][skin].bigAvatar.qianjing[theme].x = temp.qianjing.x;
                  // @ts-ignore
                  lib.qhly_skinEdit[realName][skin].bigAvatar.qianjing[theme].y = temp.qianjing.y;
                  // @ts-ignore
                  lib.qhly_skinEdit[realName][skin].bigAvatar.qianjing[theme].scale = temp.qianjing.scale / focus.offsetHeight / (1 / game.me.offsetHeight);
                  // @ts-ignore
                  lib.qhly_skinEdit[realName][skin].bigAvatar.qianjing[theme].angle = temp.qianjing.angle;
                  focus.dynamic.primary.qianjing.scale = temp.qianjing.scale;
                  focus.dynamic.primary.qianjing.angle = temp.qianjing.angle;
                }
                // @ts-ignore
            ...
            case 'qhly_bigedit7': {
              if (editDynamic) {
               ...
               /*   // @ts-ignore
                  if (!lib.qhly_skinEdit[realName][skin][editObject].qianjing) lib.qhly_skinEdit[realName][skin][editObject].qianjing = {};
                  // @ts-ignore
                  if (!lib.qhly_skinEdit[realName][skin][editObject].qianjing[theme]) lib.qhly_skinEdit[realName][skin][editObject].qianjing[theme] = {};
                  // @ts-ignore
                  lib.qhly_skinEdit[realName][skin][editObject].qianjing[theme].x = qianjingX;
                  // @ts-ignore
                  lib.qhly_skinEdit[realName][skin][editObject].qianjing[theme].y = qianjingY;
                  // @ts-ignore
                  lib.qhly_skinEdit[realName][skin][editObject].qianjing[theme].scale = qianjingS / focus.offsetHeight / (1 / game.me.offsetHeight);
                  // @ts-ignore
                  lib.qhly_skinEdit[realName][skin][editObject].qianjing[theme].angle = qianjingA;
                  focus.dynamic.primary.qianjing.x = qianjingX;
                  focus.dynamic.primary.qianjing.y = qianjingY;*/
                }
                if (focus.dynamic.primary.gongji) {
                  // @ts-ignore
                  game.qhly_postMessage(focus, {
    ...
    game.playSkillAudio = function (name, index) {
      const audioReplace = lib.config.qhly_skinset && lib.config.qhly_skinset.audioReplace;
      const resolveSkillContext = function () {
        const visited = new Set();
        let current = _status.event;
        let contextSkill = null;
        let contextPlayer = null;
        while (current && !visited.has(current)) {
          visited.add(current);
          if (!contextSkill) {
            if (typeof current.skill === 'string') {
              contextSkill = current.skill;
            } else if (typeof current.sourceSkill === 'string') {
              contextSkill = current.sourceSkill;
            } else if (typeof current.name === 'string' && lib.skill[current.name]) {
              contextSkill = current.name;
            }
          }
          if (!contextPlayer) {
            if (current.player) {
              contextPlayer = current.player;
            } else if (current.source) {
              contextPlayer = current.source;
            } else if (current._trigger && current._trigger.player) {
              contextPlayer = current._trigger.player;
            }
          }
          if (contextSkill && contextPlayer) break;
          const parent = current.parent || (typeof current.getParent === 'function' ? current.getParent() : null);
        ...
        if (!contextSkill && typeof name === 'string' && lib.skill[name]) {
          contextSkill = name;
        }
        if (!contextPlayer && _status.event && _status.event.player) {
          contextPlayer = _status.event.player;
        }
        return {
          skill: contextSkill,
      ...
      const tryFindReplacement = function (bases) {
        if (!audioReplace) return null;
        const keys = Object.keys(audioReplace);
        const seen = new Set();
        for (const base of bases) {
          if (!base || seen.has(base)) continue;
          seen.add(base);
          const normalized = (base.startsWith('skill/') || base.startsWith('../')) ? base : ('skill/' + base);
          const withIndex = (typeof index === 'number') ? normalized + index : null;
          if (withIndex && audioReplace[withIndex]) {
            return audioReplace[withIndex];
          }
          if (audioReplace[normalized]) {
            return audioReplace[normalized];
          }
          const prefixMatches = [];
          ...
          if (typeof index === 'number') {
            const exact = prefixMatches.find(key => key === normalized + index);
            if (exact) {
              return audioReplace[exact];
            }
          }
          const numericMatches = prefixMatches
            .map(key => ({
              key,
              suffix: key.slice(normalized.length),
            }))
            .filter(item => item.suffix && /^\d+$/.test(item.suffix));
          if (numericMatches.length) {
            let chosen = null;
            if (typeof index === 'number') {
              chosen = numericMatches.find(item => item.suffix === String(index)) || null;
            }
            if (!chosen) {
              chosen = numericMatches[Math.floor(Math.random() * numericMatches.length)];
      }
      return audioReplace[chosen.key];
          }
          return audioReplace[prefixMatches[0]];
        }
        return null;
      };
      const candidates = [];
      ...
      const pushCandidate = function (value) {
        if (!value || pushed.has(value)) return;
        pushed.add(value);
      ...
      if (context.skill) {
        ...
        try {
          if (context.player) {
            audioBase = game.qhly_getSkillAudioName(context.skill, context.player);
          }
        } catch (e) {
          audioBase = null;
        }
        pushCandidate(audioBase);
        pushCandidate(context.skill);
      }
      pushCandidate(name);
      const replacementPath = tryFindReplacement(candidates);
      if (replacementPath) {
        const args = replacementPath.split("/");
        if (lib.config.qhly_audioPlus) {
          // @ts-ignore
    ...
    game.qhly_getSkinFile = function (name, skin) {
      ...
      var skinPackage = game.qhly_foundPackage(realName);
      if (!skin) {
        return skinPackage.prefix + realName + ".jpg";
      }
      var dest = null;
      if (skinPackage.isLutou) {
        dest = skinPackage.skin.lutou;
      ...
      if (cp) {
        ...
        return {
          ...
          prefix: function (cname) {
            ...
            return 'extension/千幻聆音/sanguoyuanhua/' + cname + '/';
          },
          skin: {
            ...
            origin: 'extension/千幻聆音/sanguoyuanhua/',
          },
          //ssborder:,
    ...
    window.qhly_playDieAudio = function (name) {
      ...
      if (typeof game.parseDieTextMap == 'function') {
        try {
          var dieTextMap = game.parseDieTextMap(name);
          if (dieTextMap && Array.isArray(dieTextMap) && dieTextMap.length > 0) {
            var firstDie = dieTextMap.find(function(v) { return v && v.file; });
            if (firstDie && firstDie.file) {
              // @ts-ignore
              _status.qhly_audioTry = game.playAudio(firstDie.file);
              return;
            }
          }
        } catch(e) {}
  ...
  //修改
 const qhly_originalUseSkill = lib.element.content.useSkill;
    // @ts-ignore
    const originalFunc = Array.isArray(qhly_originalUseSkill) ? qhly_originalUseSkill[0] : qhly_originalUseSkill;
    // @ts-ignore
    lib.element.content.useSkill = [
      async (event, trigger, player) => {
        game.qhly_changeSkillSkin(player, event.skill);
        if (originalFunc) {
          await originalFunc(event, trigger, player);
        }
      },
      ...(Array.isArray(qhly_originalUseSkill) ? qhly_originalUseSkill.slice(1) : [])
    ];
    // @ts-ignore
    ...
    */
    ...
    game.qhly_open_new = function (name, page, ingame) {
      //try {
        ...
        var qhlyHideFunctionBtn = function (hidden) {
          if (!document.body) return;
          if (hidden) {
            document.body.classList.add('qhly-hide-function-btn');
          } else {
            document.body.classList.remove('qhly-hide-function-btn');
          }
        };
        qhlyHideFunctionBtn(true);
        if (gback && typeof gback.delete === 'function') {
          var originalGbackDelete = gback.delete;
          gback.delete = function () {
            qhlyHideFunctionBtn(false);
            return originalGbackDelete.apply(this, arguments);
          };
        }
            ...
            if (currentViewSkin.isQiLayout) {
              ...
              for (var skill of viewSkill) {
                ...
                if (detail) {
                  ...
                  if (derivation.includes(skill)) {
                    // @ts-ignore
                    content += get.qhly_getIf(currentViewSkin.skillPageDerivationSkillColor, "#2a49ac") + ";";
                  } else if (tempSkill.includes(skill)) {
                    // @ts-ignore
                    content += get.qhly_getIf(currentViewSkin.skillPageTempSkillColor, "#339933") + ";";
                  } else {
                    // @ts-ignore
                    content += get.qhly_getIf(currentViewSkin.skillPageSkillNameColor, "#b12626") + ";";
                  }
                  if (cskill.length <= 2) {
              ...
              for (var skill of viewSkill) {
                ...
                if (detail) {
                  ...
                  if (derivation.includes(skill)) {
                    // @ts-ignore
                    content += " style='color:" + get.qhly_getIf(currentViewSkin.skillPageDerivationSkillColor, "#b12626") + ";";
                  } else if (tempSkill.includes(skill)) {
                    // @ts-ignore
                    content += " style='color:" + get.qhly_getIf(currentViewSkin.skillPageDerivationSkillColor, "#339933") + ";";
                  } else {
                    // @ts-ignore
                    content += " style='color:" + get.qhly_getIf(currentViewSkin.skillPageSkillNameColor, "#2a49ac") + ";";
                  }
                  if (cplayer && lib.config.qhly_skillingame) {
                    if (!cplayer.hasSkill(skill)) {
                      content += "opacity:0.5;"
